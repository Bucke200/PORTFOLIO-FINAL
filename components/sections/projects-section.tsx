            ...
            <motion.div key={index} variants={itemVariants}>
              <Card className="overflow-hidden h-full flex flex-col border-primary/10 bg-background/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300">
                ...
                <CardFooter className="flex gap-2">
                  ...
                  >
                    <Button variant="outline" size="sm" asChild className="group relative overflow-hidden hover:shadow-md transition-all duration-300">
                  ...
                  <motion.div
                    ...
                    className="inline-block"
                  >
                    <Button size="sm" asChild className="group relative overflow-hidden hover:shadow-md transition-all duration-300">
